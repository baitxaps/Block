...
#ifndef WRClassInfo_h
#define WRClassInfo_h
...
/* OC对象 */
struct wr_objc_object {
    void *isa;
};

/* 类对象 */
struct wr_objc_class :wr_objc_object {
    Class superclass;
    cache_t cache;
...
public:
    ...
    wr_objc_class* metaClass() {
        return (wr_objc_class *)((long long)isa & ISA_MASK);
    }
};
